...
class ResCompanyInherit(models.Model):
    ...
    def get_total_beds(self):
        ...
        self.update({
            'x_studio_lit_totals' : len(self.x_studio_field_keWp2_1)
        })
        
    x_studio_available_beds_temp_1_1 = fields.Integer('Lits Disponible')
    x_studio_total_beds_temp_1 = fields.Integer('Lits totale')

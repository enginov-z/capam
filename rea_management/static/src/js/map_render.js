    ...
    _addMakers: function (records) {
        ...
        records.forEach(function (record) {
            if (record.partner && record.partner.partner_latitude && record.partner.partner_longitude) {
                ...
                var marker;
                var offset;
                console.log(record.name,record.x_studio_lit_totals,record.x_studio_lits_disponible,record.x_studio_available_beds_temp_1_1,record.x_studio_total_beds_temp_1)
